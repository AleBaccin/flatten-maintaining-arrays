	...
	cases := []struct {
		...
		// 5
		{
			...
			map[string]interface{}{
				"foo_jim":  "bean",
				"fee":      "bar",
				"n1_alist": []interface{}{"a", "b", "c", map[string]interface{}{"d": "other", "e": "another"}},
				"number":   1.4567,
				"bool":     true,
			},
			"",
		...
		// 6 -- try a prefix
		{
			...
			map[string]interface{}{
				"flag-foo_jim":  "bean",
				"flag-fee":      "bar",
				"flag-n1_alist": []interface{}{"a", "b", "c", map[string]interface{}{"d": "other", "e": "another"}},
				"flag-number":   1.4567,
				"flag-bool":     true,
			},
			"flag-",
...
func TestFlattenString(t *testing.T) {
	cases := []struct {
		...
		// 14
		{
			`{ "a": { "b" : { "c" : { "d" : "e" } } }, "array": ["1", "2"], "obj_array": [{"foo": "bar"}, {"foo": "baz"}], "number": 1.4567, "bool": true }`,
			`{ "a.b.c.d": "e", "array": ["1", "2"], "bool": true, "number": 1.4567, "obj_array": [{"foo": "bar"}, {"foo": "baz"}] }`,
			"",
			DotStyle,
			nil,
		},
